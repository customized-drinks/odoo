...
{
    'name': "DHL Paket / Business Customer Shipping Api 3.2 Integration",
    'summary': "DHL Paket / Business Customer Shipping Api 3.2 Integration",
    'description': """
DHL Paket / Business Customer Shipping Api Integration Integration
==================================================================
Send your shippings through DHL Business customer API or DHL Paket and track them online. 
After installing this module you will be able to see new delivery method called 'DHL DE Paket(Business Customer API)'. 
