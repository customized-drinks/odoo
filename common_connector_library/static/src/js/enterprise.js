odoo.define('common_connector_library.InAppEnterprise', function (require) {
    "use strict";
    ...
    WebClient.include({
        ...
        _getMenuId: function (ev) {
            var menu_id = false;
            if (ev.detail && ev.detail.menu_id) {
        ...
        _callAction: function(action_name) {
            this.do_action({
