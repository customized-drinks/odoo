...
class AmazonProductEpt(models.Model):
    ...
    fulfillment_by = fields.Selection([('FBM', 'Manufacturer Fulfillment Network'),
                                       ('FBA', 'Amazon Fulfillment Network')], default='FBM',
                                      help="Amazon Fulfillment Type")
    ...
    def search_product(self, seller_sku):
        """
        This method will search odoo product based on product seller sku.
        :param seller_sku: string (seller sku)
        :return: product.product() of False
        """
        ...
        if self.env.ref('product.product_comp_rule').active:
            ...
            product = product_obj.search(
                ['|', ('company_id', '=', False), ('company_id', '=', company_id), ('default_code', '=', seller_sku)])
            if len(product) > 1:
    ...
    def search_amazon_product(self, instance_id, seller_sku, fulfillment_by='FBM'):
        """
        This method will search and return amazon product.
        :param instance_id: amazon.instance.ept() object
        :param seller_sku: string (seller sku)
        :param fulfillment_by:
        :return: amazon.product.ept() obejct
        """
    ...
    shipping_weight = fields.Float(help="Weight of the product when packaged to ship", digits="Stock Weight")
    ...
    def get_amazon_product_request_data_ept(self, instance, data, emipro_api):
        """
        This method will prepare the amazon product request data
        :param instance: amazon.instance.ept()
        :param data: prepare data for request
        :param emipro_api: Amazon API
        :return: {}
        """
    ...
    def process_export_product_amazon_result(self, instance, data, results):
        """
        This method will create feed submission history record for
        exported amazon product stock.
        :param instance: amazon.instance.ept() object
        :param data: prepare data for request
        :param results: return response from amazon
    ...
    @staticmethod
    def standard_product_code(product):
        """
    ...
    @staticmethod
    def get_related_product_type(product):
        """
    ...
    @staticmethod
    def get_discontinue_date(product):
        """
    ...
    @staticmethod
    def get_item_dimension(product):
        """
    ...
    @staticmethod
    def item_package_qty_and_no_of_items(product):
        """
    ...
    def get_description_data(self, product):
        ...
        product.manufacturer and data.append(
            "<Manufacturer>%s</Manufacturer>" % (html.escape(product.manufacturer)))
    ...
    def export_stock_levels(self, instance):
        """
        This method will export product stock to amazon
        :param instance: amazon.instance.ept() object
        :return: boolean(TRUE/FALSE)
        """
    ...
    def process_export_stock_message_info_ept(self, instance, product_ids, amazon_products_ids,
                                              warehouse_ids):
        """
        This method will prepare data for export product stock in amazon.
        :param instance: amazon.instance.ept() object
        :param product_ids: list of product.product() ids
        :param amazon_products_ids: list of amazon.product.ept() ids
        :param warehouse_ids: list of stock.warehouse() ids
        :return: boolean(TRUE/FALSE)
        """
    ...
    def process_amazon_export_stock_dict_ept(self, instance, message_information):
        """
        This method will prepare the message information for export product stock.
        :param instance: amazon.instance.ept() object
        :param message_information: prepared message for export product stock
        :return: boolean(TRUE/FALSE)
        """
    ...
    def process_amazon_export_stock_response_ept(self, instance, data, response):
        ...
        :param instance: amazon.instance.ept() object
        :param data: prepare message for export stock in amazon
        :param response: return response from amazon
        :return: boolean(TRUE/FALSE)
        """
    ...
    def process_amazon_update_price_result(self, instance, data, results):
        """
        This method will create feed submission history record for product
        price updated in amazon.
        :param instance: amazon.instance.ept() object
        :param data: prepare message for export stock in amazon
        :param results: return response from amazon
        :return: boolean(TRUE/FALSE)
    ...
    def process_amazon_update_image_result(self, instance, results, data):
        """
        This method will create feed submission history record for product image
        updated in amazon.
        :param instance: amazon.instance.ept() object
        :param results: return response from amazon
        :param data: prepare message for update image in amazon
        :return: boolean(TRUE/FALSE)
        """
        amazon_process_job_log_obj = self.env['common.log.book.ept']
        feed_submission_obj = self.env['feed.submission.history']
