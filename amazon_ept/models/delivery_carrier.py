...
class DeliveryCarrier(models.Model):
    ...
    amz_carrier_code = fields.Selection([('Blue Package', 'Blue Package'),
                                         ...
                                         ('4PX', '4PX'), ('A_1', 'A-1'), ('AAA Cooper', 'AAA Cooper'), ('ABF', 'ABF'),
                                         ('Asendia', 'Asendia'), ('Best Buy', 'Best Buy'),
                                         ('CEVA', 'CEVA'), ('China Post', 'China Post'),
                                         ('Conway', 'Conway'), ('DHL eCommerce', 'DHL eCommerce'),
                                         ('Estes', 'Estes'), ('Fedex Freight', 'Fedex Freight'),
                                         ('First Mile', 'First Mile'),
                                         ('Hongkong Post', 'Hongkong Post'), ('Hunter Logistics', 'Hunter Logistics'),
                                         ('India Post', 'India Post'), ('JCEX', 'JCEX'),
                                         ('Old Dominion', 'Old Dominion'),
                                         ('Pilot Freight', 'Pilot Freight'), ("R_L", "R+L"),
                                         ('Roadrunner', 'Roadrunner'), ('Saia', 'Saia'),
                                         ('SF Express', 'SF Express'), ('SFC', 'SFC'),
                                         ('UPS Freight', 'UPS Freight'),
                                         ('Urban Express', 'Urban Express'),
                                         ('XPO Freight', 'XPO Freight'),
                                         ('Yellow Freight', 'Yellow Freight'), ('Yun Express', 'Yun Express'),
                                         ('Estafeta', 'Estafeta'), ('PUROLATOR', 'PUROLATOR'),
                                         ('Ninjavan', 'Ninjavan'), ('Qxpress', 'Qxpress'),
                                         ('Singapore Post', 'Singapore Post'), ('Aramex', 'Aramex'),
                                         ('YANWEN', 'YANWEN'), ('Other', 'Other')], "Amazon Carrier Code")
