...
class StockQuantPackage(models.Model):
    ...
    def default_get(self, fields):
        """
        This method will Add domain in Amazon Product field while enter Carton Information,
    ...
    def _compute_amazon_products(self):
        ...
        for record in self:
            ...
            if shipment:
                ...
                record.amazon_product_ids = False
        return res

    def get_amazon_products(self, inbound_shipment):
        """
        Return Amazon Products which are in Shipment Lines
        :param inbound_shipment: amazon.inbound.shipment.ept() object
        :return: list of amazon products ids
        """
