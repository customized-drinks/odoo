...
class VatConfigEpt(models.Model):
    ...
    is_auto_create_taxes = fields.Boolean("Auto Create Taxes?", default=False, help="Mark true for auto create taxes"
                                                                                    " and set into newly created"
                                                                                    " fiscal positions.")
    ...
    def create(self, vals):
        """
        Inherited create method for creating excluded_vat_group
        countries country to country[B2C] fiscal position based on VAT number configuration
