...
class SettlementReportConfigureFeesEPT(models.TransientModel):
    ...
    def configure_settlement_report_fees(self):
        ...
        for configure_line in self.settlement_report_configure_line_ids:
            ...
            analytic_account_id = configure_line.analytic_account_id and configure_line.analytic_account_id.id or False
            ...
            if amazon_code:
                ...
                line_id = transaction_line_obj.search([('amazon_code', '=', amazon_code), ('seller_id', '=', settlement_id.seller_id.id)])
                if not line_id:
