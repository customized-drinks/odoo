        ...
        for seller in sellers:
            try:
                if self._context.get('active_seller'):
                    self.env['amazon.seller.ept'].browse(seller).with_context({'confirm_archive': True}).archive_seller()
                else:
                    self.env['amazon.seller.ept'].browse(seller).with_context({'confirm_un_archive': True}).unarchive_seller()
