...
class AmazonConfigSettings(models.TransientModel):
    ...
    amz_instance_id = fields.Many2one(AMAZON_INSTANCE_EPT, string='Amazon Instance',
                                      help="Select Amazon Instance")
    amz_instance_removal_order = fields.Many2one(AMAZON_INSTANCE_EPT,
    ...
    def onchange_amz_seller_id(self):
        ...
        if self.amz_seller_id:
            ...
            if removal_instance_id:
                ...
                vals['value']['removal_warehouse_id'] = removal_instance_id.removal_warehouse_id.id if \
    ...
    def sync_fba_fulfilment_centers(self):
        """
        When 'sync fulfilment center button' clicked from amazon configuration settings
        This method will call the method 'request_fba_fulfilment_centers' of amazon seller
        which will sync new fulfilment centers to all the amazon fba warehouse
        """
        active_seller = request.session['amz_seller_id']
