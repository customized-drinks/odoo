...
class AmazonInboundImportShipmentWizard(models.TransientModel):
    ...
    def create_amazon_inbound_shipment_line(self, items, inbound_shipment_id, instance_id):
        ...
        for item in items:
            ...
            amazon_inbound_shipment_plan_line_obj.create({
                ...
                'seller_sku': seller_sku, 'quantity': received_qty,
                'fn_sku': fn_sku, 'odoo_shipment_id': inbound_shipment_id,
    ...
    def create_amazon_inbound_shipment(self, results, instance_id, from_warehouse_id, ship_to_address):
        ...
        for result in results:
            shipment_name = result.get('ShipmentName', '')
            ...
            fulfillment_center_id = result.get('DestinationFulfillmentCenterId', '')
